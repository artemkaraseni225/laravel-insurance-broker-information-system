...
class AiDataExtractionService
{
    ...
    private const SCHEMAS = [
        ...
        'property' => [
            'property_address' => 'Точный адрес объекта: город, улица, дом, квартира (строка)',
...
- Для мер, площади и других числовых полей извлекай число
  из приблизительных формулировок: «где-то 50», «около 50»
  или «может чуть больше 50 кв. м» нужно вернуть как 50.
